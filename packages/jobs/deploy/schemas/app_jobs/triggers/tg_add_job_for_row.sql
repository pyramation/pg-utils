-- Deploy schemas/app_jobs/triggers/tg_add_job_for_row to pg

-- requires: schemas/app_jobs/schema

BEGIN;

CREATE FUNCTION app_jobs.tg_add_job_for_row() RETURNS TRIGGER AS $$
BEGIN
...
COMMENT ON FUNCTION app_jobs.tg_add_job_for_row IS

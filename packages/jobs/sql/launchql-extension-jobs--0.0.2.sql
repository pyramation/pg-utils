...
CREATE FUNCTION app_jobs.add_job ( identifier text, payload json DEFAULT '{}'::json, queue_name text DEFAULT NULL, run_at timestamptz DEFAULT now(), max_attempts int DEFAULT 25, priority int DEFAULT 0 ) RETURNS app_jobs.jobs AS $EOFCODE$
DECLARE
  v_job app_jobs.jobs;
BEGIN
